---
title: "한국외대 통계학과 영상 개체인식 개발 프로젝트"
author: "lovetoken"
date: "`r Sys.Date()`"
output: 
...
## attach library
useful.lovetoken::librarys(c("knitr", "servr", "dplyr", "useful.lovetoken"), auto.upd=F, message=F)
...
library(waffle)
parts <- c(Expected_progress=1, Remaining_journey=99)
waffle(parts, rows=5, colors=c("blue", "green"))
```
